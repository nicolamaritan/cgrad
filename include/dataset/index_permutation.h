...
cgrad_error index_permutation_sample_index_batch(const index_permutation *const index_permutation, indexes_batch *const index_batch, const size_t batch_size);
...
static inline size_t index_permutation_get_remaining(const index_permutation *const permutation);
...
static inline size_t index_permutation_get_remaining(const index_permutation *const permutation)
{
    return permutation->size - permutation->current;
}
