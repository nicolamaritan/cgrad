 ...
 */
typedef struct indexes_permutation
{
 ...
 */
static inline void index_permutation_update(indexes_permutation *const ixs_permutation, const size_t batch_size);
 ...
 */
static inline bool index_permutation_is_terminated(const indexes_permutation *const ixs_permutation);
 ...
 */
static inline size_t index_permutation_get_remaining(const indexes_permutation *const ixs_permutation);
